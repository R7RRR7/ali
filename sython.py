...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id :
        order = await event.reply('- ها ضلعي يمك محمد اخدمني بشي | @mmaahg')
...
async def _(event):
        ...
        await sython.send_message('@EEObot', 'جاري التجميع بواسطة | 𝐒𝐎𝐔𝐑𝐂𝐄 𝒎𝒉𝒎𝒂𝒅')
        channel_entity = await sython.get_entity(bot_username)
...
async def _(event):
        ...
        await sython.send_message('@A_MAN9300BOT', 'جاري التجميع بواسطة | 𝐒𝐎𝐔𝐑𝐂𝐄 𝒎𝒉𝒎𝒂𝒅')
        channel_entity = await sython.get_entity(bot_usernamee)
...
async def _(event):
      await event.reply("""
༗ 𝐖𝐄𝑳𝐂𝐎𝐌𝐄 𝐓𝐎 𝐒𝐎𝐔𝐑𝐂𝐄 𝒎𝒉𝒎𝒂𝒅 🦅
༗ 𝐓𝐇𝐄 𝐁𝐄𝐒𝐓 𝐒𝐎𝐔𝐑𝐂𝐄 𝐎𝐍 𝐓𝐄𝑳𝐄𝐆𝐑𝐀𝐌
༗ 𝐂𝐇𝐀𝐍𝐍𝐄𝑳 𝐒𝐎𝐔𝐑𝐂𝐄 : @mmaahg
"""
)
